 ...
 * To configure <strong>Kafka Connect</strong> via it's RUST-API this package uses <a href="https://square.github.io/retrofit/">Retrofit</a>.
 * </p><p>
 * The package should configure <em>Zeebe Source Connectors</em> and <em>Zeebe Sink Connectors</em> so
 * that <strong>Kafka</strong> can send events between a <strong>zeebe</strong>
